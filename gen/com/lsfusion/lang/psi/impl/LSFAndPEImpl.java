...
public class LSFAndPEImpl extends ASTWrapperPsiElement implements LSFAndPE {

  public LSFAndPEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitAndPE(this);
  }
  ...
  @Override
  @NotNull
  public List<LSFNotPE> getNotPEList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LSFNotPE.class);
  }
