...
public class LSFEqualityPEImpl extends ASTWrapperPsiElement implements LSFEqualityPE {

  public LSFEqualityPEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitEqualityPE(this);
  }
  ...
  @Override
  @NotNull
  public List<LSFRelationalPE> getRelationalPEList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LSFRelationalPE.class);
  }
