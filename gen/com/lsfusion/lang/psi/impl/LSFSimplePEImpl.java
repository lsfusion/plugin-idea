...
public class LSFSimplePEImpl extends ASTWrapperPsiElement implements LSFSimplePE {

  public LSFSimplePEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitSimplePE(this);
  }
  ...
  @Override
  @Nullable
  public LSFExpressionPrimitive getExpressionPrimitive() {
    return PsiTreeUtil.getChildOfType(this, LSFExpressionPrimitive.class);
  }
