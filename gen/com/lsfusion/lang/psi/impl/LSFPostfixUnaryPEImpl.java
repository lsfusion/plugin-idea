...
public class LSFPostfixUnaryPEImpl extends ASTWrapperPsiElement implements LSFPostfixUnaryPE {

  public LSFPostfixUnaryPEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitPostfixUnaryPE(this);
  }
  ...
  @Override
  @NotNull
  public LSFSimplePE getSimplePE() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, LSFSimplePE.class));
  }

  @Override
  @Nullable
  public LSFTypePropertyDefinition getTypePropertyDefinition() {
    return PsiTreeUtil.getChildOfType(this, LSFTypePropertyDefinition.class);
  }
