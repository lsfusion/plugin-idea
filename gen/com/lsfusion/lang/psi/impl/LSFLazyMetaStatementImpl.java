...
public class LSFLazyMetaStatementImpl extends LSFLazyParsableElement implements LSFLazyMetaStatement {

  public LSFLazyMetaStatementImpl(ASTNode node) {
    super(node);
  }

  public LSFLazyMetaStatementImpl(@NotNull IElementType elementType, CharSequence buffer) {
    super(elementType, buffer);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitLazyMetaStatement(this);
  }
