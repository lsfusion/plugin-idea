...
public class LSFFormulaPropertyDefinitionImpl extends ASTWrapperPsiElement implements LSFFormulaPropertyDefinition {

  public LSFFormulaPropertyDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitFormulaPropertyDefinition(this);
  }
  ...
  @Override
  @Nullable
  public LSFFormulaPropertySyntaxList getFormulaPropertySyntaxList() {
    return PsiTreeUtil.getChildOfType(this, LSFFormulaPropertySyntaxList.class);
  }
