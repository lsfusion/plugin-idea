...
public class LSFRelationalPEImpl extends ASTWrapperPsiElement implements LSFRelationalPE {

  public LSFRelationalPEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitRelationalPE(this);
  }
  ...
  @Override
  @NotNull
  public List<LSFLikePE> getLikePEList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LSFLikePE.class);
  }
