...
public class LSFCustomActionPropertyDefinitionBodyImpl extends ASTWrapperPsiElement implements LSFCustomActionPropertyDefinitionBody {

  public LSFCustomActionPropertyDefinitionBodyImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitCustomActionPropertyDefinitionBody(this);
  }
  ...
  @Override
  @Nullable
  public LSFBracketedClassNameList getBracketedClassNameList() {
    return PsiTreeUtil.getChildOfType(this, LSFBracketedClassNameList.class);
  }

  @Override
  @Nullable
  public LSFCodeLiteral getCodeLiteral() {
    return PsiTreeUtil.getChildOfType(this, LSFCodeLiteral.class);
  }

  @Override
  @Nullable
  public LSFJavaClassStringUsage getJavaClassStringUsage() {
    return PsiTreeUtil.getChildOfType(this, LSFJavaClassStringUsage.class);
  }

  @Override
  @Nullable
  public LSFJsStringUsage getJsStringUsage() {
    return PsiTreeUtil.getChildOfType(this, LSFJsStringUsage.class);
  }
  ...
  @Override
  public @Nullable LSFExplicitClasses getValueParamClassNames() {
