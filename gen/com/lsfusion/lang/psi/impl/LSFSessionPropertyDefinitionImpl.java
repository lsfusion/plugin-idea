...
public class LSFSessionPropertyDefinitionImpl extends ASTWrapperPsiElement implements LSFSessionPropertyDefinition {

  public LSFSessionPropertyDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitSessionPropertyDefinition(this);
  }
  ...
  @Override
  @NotNull
  public LSFSessionPropertyType getSessionPropertyType() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, LSFSessionPropertyType.class));
  }
