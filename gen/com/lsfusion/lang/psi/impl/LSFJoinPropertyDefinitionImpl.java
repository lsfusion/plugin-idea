...
public class LSFJoinPropertyDefinitionImpl extends ASTWrapperPsiElement implements LSFJoinPropertyDefinition {

  public LSFJoinPropertyDefinitionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitJoinPropertyDefinition(this);
  }
  ...
  @Override
  @Nullable
  public LSFPropertyExprObject getPropertyExprObject() {
    return PsiTreeUtil.getChildOfType(this, LSFPropertyExprObject.class);
  }

  @Override
  @Nullable
  public LSFPropertyExpressionList getPropertyExpressionList() {
    return PsiTreeUtil.getChildOfType(this, LSFPropertyExpressionList.class);
  }
