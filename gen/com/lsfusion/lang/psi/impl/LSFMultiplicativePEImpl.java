...
public class LSFMultiplicativePEImpl extends ASTWrapperPsiElement implements LSFMultiplicativePE {

  public LSFMultiplicativePEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitMultiplicativePE(this);
  }
  ...
  @Override
  @NotNull
  public List<LSFTypeMult> getTypeMultList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LSFTypeMult.class);
  }

  @Override
  @NotNull
  public List<LSFUnaryMinusPE> getUnaryMinusPEList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LSFUnaryMinusPE.class);
  }
