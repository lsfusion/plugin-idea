...
public class LSFOrPEImpl extends ASTWrapperPsiElement implements LSFOrPE {

  public LSFOrPEImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitOrPE(this);
  }
  ...
  @Override
  @NotNull
  public List<LSFXorPE> getXorPEList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LSFXorPE.class);
  }
