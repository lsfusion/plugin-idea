...
public class LSFMappedPropertyExprParamImpl extends ASTWrapperPsiElement implements LSFMappedPropertyExprParam {

  public LSFMappedPropertyExprParamImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LSFVisitor visitor) {
    visitor.visitMappedPropertyExprParam(this);
  }
  ...
  public LSFExprParameterUsageList getExprParameterUsageList() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, LSFExprParameterUsageList.class));
  }
