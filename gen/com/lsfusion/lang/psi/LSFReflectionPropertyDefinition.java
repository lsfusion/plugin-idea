...
public interface LSFReflectionPropertyDefinition extends UnfriendlyPE {

  @Nullable
  LSFActionUsage getActionUsage();

  @Nullable
  LSFPropertyElseActionUsage getPropertyElseActionUsage();

  @NotNull
  LSFReflectionPropertyType getReflectionPropertyType();
