...
public interface LSFSeekObjectActionPropertyDefinitionBody extends ActionExpression, FormContext {

  @Nullable
  LSFGroupObjectID getGroupObjectID();

  @NotNull
  List<LSFObjectExpr> getObjectExprList();

  @Nullable
  LSFObjectID getObjectID();
