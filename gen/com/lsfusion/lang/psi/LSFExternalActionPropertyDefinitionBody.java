...
public interface LSFExternalActionPropertyDefinitionBody extends ActionExpression {

  @NotNull
  List<LSFHeadersPropertyUsage> getHeadersPropertyUsageList();

  @Nullable
  LSFNonEmptyNoParamsPropertyUsageList getNonEmptyNoParamsPropertyUsageList();
