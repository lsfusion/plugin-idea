...
public interface LSFEmailActionPropertyDefinitionBody extends ActionExpression {

  @NotNull
  List<LSFEmailPropertyUsage> getEmailPropertyUsageList();

  @NotNull
  List<LSFEmailRecipientTypeLiteral> getEmailRecipientTypeLiteralList();
