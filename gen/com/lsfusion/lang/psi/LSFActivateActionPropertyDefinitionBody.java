...
public interface LSFActivateActionPropertyDefinitionBody extends ActionExpression {

  @Nullable
  LSFComponentID getComponentID();

  @Nullable
  LSFFormPropertyDrawID getFormPropertyDrawID();
