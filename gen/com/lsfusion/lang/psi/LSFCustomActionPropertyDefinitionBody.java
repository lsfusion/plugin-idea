...
public interface LSFCustomActionPropertyDefinitionBody extends UnfriendlyPE {

  @Nullable
  LSFBracketedClassNameList getBracketedClassNameList();

  @Nullable
  LSFCodeLiteral getCodeLiteral();

  @Nullable
  LSFJavaClassStringUsage getJavaClassStringUsage();

  @Nullable
  LSFJsStringUsage getJsStringUsage();
  ...
  @Nullable LSFExplicitClasses getValueParamClassNames();
