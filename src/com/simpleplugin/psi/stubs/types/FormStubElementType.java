...
import com.simpleplugin.psi.stubs.impl.FormStubImpl;
import com.simpleplugin.psi.stubs.types.indexes.FormIndex;
...
public class FormStubElementType extends FullNameStubElementType<FormStubElement, LSFFormDeclaration> {
    ...
    public LSFFormDeclaration createPsi(@NotNull FormStubElement stub) {
        return new com.simpleplugin.psi.impl.LSFFormDeclImpl(stub, this);
    }
