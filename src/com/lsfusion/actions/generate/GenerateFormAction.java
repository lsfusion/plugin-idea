...
public abstract class GenerateFormAction extends AnAction {
    ...
    private final Set<String> keywords = new HashSet<>(Arrays.asList("TRUE", "FALSE", "TTRUE", "TFALSE", "INTEGER", "LONG", "NUMERIC", "DOUBLE", "DATE", "DATETIME", "TIME", "YEAR",
            ...
            "DROP", "DROPCHANGED", "DROPPED", "ECHO", "EDIT", "ELSE", "EMAIL", "EMBEDDED", "END", "ESCAPE", "EVAL", "EVENTID",
            "EVENTS", "EXCEPTLAST", "EXCLUSIVE", "EXEC", "EXPAND", "EXTERNAL", "NEWEXECUTOR", "EXPORT",
            ...
            "INDEX", "INDEXED", "INIT", "INLINE", "INPUT", "INTERNAL", "IS", "JAVA", "JOIN", "JSON", "JSONTEXT", "KEY",
