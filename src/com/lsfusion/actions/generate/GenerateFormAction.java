...
public abstract class GenerateFormAction extends AnAction {
    ...
    private Set<String> keywords = new HashSet<>(Arrays.asList("TRUE", "FALSE", "TTRUE", "TFALSE", "INTEGER", "LONG", "NUMERIC", "DOUBLE", "DATE", "DATETIME", "TIME", "YEAR",
            ...
            "EXTEND", "EXTID", "EXTNULL", "FIELDS", "FILTER", "FILTERGROUP", "FILTERGROUPS", "FILTERS", "FINALLY", "FIRST", "FIXED", "FLEX", "FLOAT", "FOLDER", "FOOTER", "FOR", "FOREGROUND",
            ...
            "LOCALASYNC", "LOGGABLE", "LSF", "MANAGESESSION", "NOMANAGESESSION", "MAP", "MATCH", "MATERIALIZED", "MAX", "MEASURE", "MEASURES", "MENU", "MEMO", "MESSAGE", "META", "MIN",
            ...
            "NOSTICKY", "OBJECT", "OBJECTS", "CONSTRAINTFILTER", "OK", "ON", "OPTIMISTICASYNC", "OR", "ORDER", "ORDERS", "OVERRIDE", "PAGESIZE", "PANEL", "PARENT", "PARTITION", "PASSWORD",
            ...
            "REPORT", "REPORTFILES", "REQUEST", "REQUIRE", "RESOLVE", "RETURN", "RGB", "RIGHT", "ROUND", "ROOT", "ROW", "ROWS", "RTF", "SCROLL", "SEEK", "SELECTOR", "SERIALIZABLE", "SERVER",
