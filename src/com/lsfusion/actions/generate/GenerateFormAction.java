...
public abstract class GenerateFormAction extends AnAction {
    ...
    private Set<String> keywords = new HashSet<>(Arrays.asList("TRUE", "FALSE", "INTEGER", "LONG", "NUMERIC", "DOUBLE", "DATE", "DATETIME", "TIME", "YEAR", "ZDATETIME", "INTERVAL",
            "BPSTRING", "BPISTRING", "STRING", "ISTRING", "TEXT", "RICHTEXT", "WORDFILE", "IMAGEFILE", "PDFFILE", "DBFFILE", "RAWFILE", "FILE", "EXCELFILE", "TEXTFILE", "CSVFILE",
            "HTMLFILE", "JSONFILE", "XMLFILE", "TABLEFILE", "WORDLINK", "IMAGELINK", "PDFLINK", "DBFLINK", "RAWLINK", "LINK", "EXCELLINK", "TEXTLINK", "CSVLINK", "HTMLLINK",
            "JSONLINK", "XMLLINK", "TABLELINK", "BOOLEAN", "TBOOLEAN", "COLOR", "ABSTRACT", "ACTIVATE", "ACTIVE", "ATTR", "ASK", "NATIVE", "ACTION", "AFTER", "GOAFTER", "AGGR",
            "NAGGR", "ALL", "AND",  "APPEND", "APPLY", "AS", "ASON", "ASYNCUPDATE", "ATTACH", "AUTOREFRESH", "AUTOSET", "BACKGROUND", "BCC", "BEFORE", "BODY", "BODYPARAMNAMES",
            "BODYPARAMHEADERS", "BODYURL", "BOTTOM", "BOX", "BREAK",
