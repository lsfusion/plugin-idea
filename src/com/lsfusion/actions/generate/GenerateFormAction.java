...
public abstract class GenerateFormAction extends AnAction {
    ...
    private Set<String> keywords = new HashSet<>(Arrays.asList("TRUE", "FALSE", "TTRUE", "TFALSE", "INTEGER", "LONG", "NUMERIC", "DOUBLE", "DATE", "DATETIME", "TIME", "YEAR",
            ...
            "DESC", "DESIGN", "DIALOG", "DISABLEIF", "DO", "DOC", "DOCKED", "DOCX", "DOWN", "DRAWROOT", "DRILLDOWN", "DROP", "DROPCHANGED", "DROPPED",
            ...
            "INDEX", "INDEXED", "INIT", "INLINE", "INPUT", "INTERNAL", "IS", "JAVA", "JOIN", "JSON", "JSONTEXT", "KEYPRESS", "LAST", "LEFT", "LIKE", "LIMIT", "LIST", "LOCAL",
            ...
            "NOCOMPLEX", "NODEFAULT", "NOEXTID", "NOESCAPE", "NOFLEX", "NOCHANGE", "NOCONSTRAINTFILTER", "NOIMAGE", "NOINLINE", "NOHEADER", "NOSELECT", "NOSETTINGS", "NOT", "WAIT", "NOWAIT",
            ...
            "PARTITION", "PASSWORD", "PATCH", "PDF", "PERIOD", "PIVOT", "PG", "POPUP", "POSITION", "POST", "PREREAD", "PREV",
            "PREVIEW", "NOPREVIEW", "PARAMS", "PRINT", "PRIORITY", "PROPERTIES",
            "PROPERTY", "PROPERTYDRAW", "PROPORTION", "PUT", "QUERYCLOSE", "QUICKFILTER", "READ", "READONLY", "READONLYIF", "RECALCULATE", "RECURSION", "REFLECTION", "REGEXP", "REMOVE",
