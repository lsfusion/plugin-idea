...
public abstract class McpBaseService extends RestService {
    ...
    private static JSONObject buildRetrieveDocsToolDescriptor() {
        ...
        JSONObject inputSchema = new JSONObject()
                ...
                // No `required`: either selector is enough, and demanding `query` here
                // would make an article-only call unpassable through this proxy.
                .put("additionalProperties", false);
