...
//    @NotNull
//    public static ASTNode createNewPartitionBy(Project myProject, String partitionBy) {
//        final PsiFile dummyFile = createDummyFile(myProject, "MODULE " + genName + "; f()=PARTITION " + partitionBy + " SUM 1;");
//        return PsiTreeUtil.findChildrenOfType(dummyFile, LSFNewPartitionPropertyBy.class).iterator().next().getNode();
//    }
//
//    @NotNull
//    public static ASTNode createNewImportFrom(Project myProject, String fromClause) {
//        final PsiFile dummyFile = createDummyFile(myProject, "MODULE " + genName + "; f()={IMPORT " + fromClause + " TO a;}");
//        return PsiTreeUtil.findChildrenOfType(dummyFile, LSFNewFrom.class).iterator().next().getNode();
//    }
//
//    @NotNull
//    public static LSFBracedPE createBracedPE(Project myProject, String pe) {
//        final PsiFile dummyFile = createDummyFile(myProject, "MODULE " + genName + "; f()=(" + pe + ");");
//        return PsiTreeUtil.findChildOfType(dummyFile, LSFBracedPE.class);
//    }
