...
public class ImplicitValueIndex extends LSFStringStubIndex<LSFImplicitValuePropStatement> {
    ...
    @Override
    protected Class<LSFImplicitValuePropStatement> getPsiClass() {
        return LSFImplicitValuePropStatement.class;
    }
}
