...
public abstract class LSFActionDeclarationImpl extends LSFActionOrGlobalPropDeclarationImpl<LSFActionDeclaration, ActionStubElement> {
    
    public LSFActionDeclarationImpl(@NotNull ASTNode node) {
        super(node);
    }

    public LSFActionDeclarationImpl(@NotNull ActionStubElement actionStubElement, @NotNull IStubElementType nodeType) {
