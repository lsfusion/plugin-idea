...
public final class LSFIcons {
    public static final Icon ABSTRACT_PROPERTY = IconLoader.getIcon("/images/abstract_property.png", LSFIcons.class.getClassLoader());
    public static final Icon ACTION = IconLoader.getIcon("/images/action.png", LSFIcons.class.getClassLoader());
    public static final Icon CLASS = AllIcons.Nodes.Class;
    public static final Icon CONSTRAINT = AllIcons.General.Warning;
    public static final Icon DATA_PROPERTY = IconLoader.getIcon("/images/data_property.png", LSFIcons.class.getClassLoader());
    public static final Icon EVENT = AllIcons.Actions.Execute;
    public static final Icon FILE = IconLoader.getIcon("/images/lsf_logo.png", LSFIcons.class.getClassLoader());
    public static final Icon MODULE = IconLoader.getIcon("/images/lsf_logo.png", LSFIcons.class.getClassLoader());
    public static final Icon LIBRARY = IconLoader.getIcon("/images/lsf_logo.png", LSFIcons.class.getClassLoader());
    public static final Icon RUN = IconLoader.getIcon("/images/lsf_logo.png", LSFIcons.class.getClassLoader());
    ...
    public static final Icon FILTER = IconLoader.getIcon("/images/design/filt.png", LSFIcons.class.getClassLoader());
    ...
    public static final Icon NUMBER_SORT = IconLoader.getIcon("/images/number_sort.png", LSFIcons.class.getClassLoader());
    ...
    public static final Icon PRINT = IconLoader.getIcon("/images/print.png", LSFIcons.class.getClassLoader());
    public static final Icon EDIT_REPORT = IconLoader.getIcon("/images/editReport.png", LSFIcons.class.getClassLoader());
    public static final Icon EDIT_AUTO_REPORT = IconLoader.getIcon("/images/editAutoReport.png", LSFIcons.class.getClassLoader());
    public static final Icon DELETE_REPORT = IconLoader.getIcon("/images/deleteReport.png", LSFIcons.class.getClassLoader());
    ...
    public static final class Design {
        ...
        public static final Icon FILTER = IconLoader.getIcon("/images/design/filt.png", LSFIcons.class.getClassLoader());
        public static final Icon FILTER_ADD = IconLoader.getIcon("/images/design/filtadd.png", LSFIcons.class.getClassLoader());
        public static final Icon FILTER_APPLY = IconLoader.getIcon("/images/design/ok.png", LSFIcons.class.getClassLoader());
        public static final Icon FILTER_RESET = IconLoader.getIcon("/images/design/filtreset.png", LSFIcons.class.getClassLoader());
        ...
        public static final Icon PIVOT = IconLoader.getIcon("/images/design/pivot.png", LSFIcons.class.getClassLoader());
        public static final Icon PREFERENCES = IconLoader.getIcon("/images/design/userPreferences.png", LSFIcons.class.getClassLoader());
        public static final Icon QUANTITY = IconLoader.getIcon("/images/design/quantity.png", LSFIcons.class.getClassLoader());
        public static final Icon SUM = IconLoader.getIcon("/images/design/sum.png", LSFIcons.class.getClassLoader());
        public static final Icon PRINT_XLS = IconLoader.getIcon("/images/design/excelbw.png", LSFIcons.class.getClassLoader());
    }
}